...
import { loginSchema } from "@/validation/facultyValidation";
  ...
  return (
    <div className="min-h-screen w-full flex justify-center items-center">
      <Card className="w-full max-w-md">
        <CardHeader>
          <h1 className="text-2xl mb-4 text-center">Login Faculty</h1>
        </CardHeader>
        <CardContent>
          ...
          <div className="mt-4 text-center">
            <p>
              ...
              <Link to="/faculty/register" className="underline">
                Register
              </Link>
            </p>
          </div>
